use utf8;
package DBIC::IMG_Core::Result::TaxonStat;
...
DBIC::IMG_Core::Result::TaxonStat
...
=head1 TABLE: C<TAXON_STATS>

=cut

__PACKAGE__->table("TAXON_STATS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3SzweXlUuIb03Nt3UPHq1Q
