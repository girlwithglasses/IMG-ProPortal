use utf8;
package DBIC::IMG_Core::Result::GeneCassettePanfold;
...
=head1 TABLE: C<GENE_CASSETTE_PANFOLDS>

=cut

__PACKAGE__->table("GENE_CASSETTE_PANFOLDS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gr89ceHbGcFNIPWDkOQF4w
