use utf8;
package DBIC::IMG_Core::Result::GoldImgNatProdEntity;
...
DBIC::IMG_Core::Result::GoldImgNatProdEntity
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OElb8VlaDQsWKpV9kvDPTQ
