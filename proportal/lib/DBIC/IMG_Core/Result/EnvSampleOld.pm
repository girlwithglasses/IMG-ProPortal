use utf8;
package DBIC::IMG_Core::Result::EnvSampleOld;
...
DBIC::IMG_Core::Result::EnvSampleOld
...
=head1 TABLE: C<ENV_SAMPLE_OLD>

=cut

__PACKAGE__->table("ENV_SAMPLE_OLD");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EusNMfraSU+cQ3dTtMGZVg
