use utf8;
package DBIC::IMG_Core::Result::DtCogStat;
...
DBIC::IMG_Core::Result::DtCogStat
...
=head1 TABLE: C<DT_COG_STATS>

=cut

__PACKAGE__->table("DT_COG_STATS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Fc6wH3VvuOklkBGurh5cHg
