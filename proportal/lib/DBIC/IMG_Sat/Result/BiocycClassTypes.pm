use utf8;
package DBIC::IMG_Sat::Result::BiocycClassTypes;
...
=head1 TABLE: C<BIOCYC_CLASS_TYPES>

=cut

__PACKAGE__->table("BIOCYC_CLASS_TYPES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lhjPRATrx+o+Ef71bGVezA
