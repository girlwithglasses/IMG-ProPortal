use utf8;
package DBIC::IMG_Sat::Result::BiocycReactionSynonyms;
...
=head1 TABLE: C<BIOCYC_REACTION_SYNONYMS>

=cut

__PACKAGE__->table("BIOCYC_REACTION_SYNONYMS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vUz3C7zialXqBbWjlgOXBA
