use utf8;
package DBIC::IMG_Sat::Result::PfamFamilyGenomeProperties;
...
=head1 TABLE: C<PFAM_FAMILY_GENOME_PROPERTIES>

=cut

__PACKAGE__->table("PFAM_FAMILY_GENOME_PROPERTIES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6y3xLb9DzxTcNhO+iEoMaA
