use utf8;
package DBIC::IMG_Sat::Result::CogFunctionsObs;
...
=head1 TABLE: C<COG_FUNCTIONS_OBS>

=cut

__PACKAGE__->table("COG_FUNCTIONS_OBS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b1ataWqmcMDQfTQdpn/FKA
