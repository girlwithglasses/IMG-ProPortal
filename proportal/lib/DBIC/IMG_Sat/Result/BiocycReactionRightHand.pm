use utf8;
package DBIC::IMG_Sat::Result::BiocycReactionRightHand;
...
=head1 TABLE: C<BIOCYC_REACTION_RIGHT_HAND>

=cut

__PACKAGE__->table("BIOCYC_REACTION_RIGHT_HAND");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ro66yFhuBVLiPbGHbXfK1w
