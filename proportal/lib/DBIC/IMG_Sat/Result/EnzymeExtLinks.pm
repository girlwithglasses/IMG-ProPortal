use utf8;
package DBIC::IMG_Sat::Result::EnzymeExtLinks;
...
=head1 TABLE: C<ENZYME_EXT_LINKS>

=cut

__PACKAGE__->table("ENZYME_EXT_LINKS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SQDH3hdTE3p84sxW/ZbwZA
