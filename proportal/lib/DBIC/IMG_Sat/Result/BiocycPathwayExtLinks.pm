use utf8;
package DBIC::IMG_Sat::Result::BiocycPathwayExtLinks;
...
=head1 TABLE: C<BIOCYC_PATHWAY_EXT_LINKS>

=cut

__PACKAGE__->table("BIOCYC_PATHWAY_EXT_LINKS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:za89gJagg2OOTi4Y5wf36A
