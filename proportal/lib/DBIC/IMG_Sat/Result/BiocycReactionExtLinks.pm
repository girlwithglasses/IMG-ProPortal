use utf8;
package DBIC::IMG_Sat::Result::BiocycReactionExtLinks;
...
=head1 TABLE: C<BIOCYC_REACTION_EXT_LINKS>

=cut

__PACKAGE__->table("BIOCYC_REACTION_EXT_LINKS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kq5+UWTCYLzCKIVqJMLdbw
