use utf8;
package DBIC::IMG_Sat::Result::BiocycProteinTypes;
...
=head1 TABLE: C<BIOCYC_PROTEIN_TYPES>

=cut

__PACKAGE__->table("BIOCYC_PROTEIN_TYPES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SLcRElfNMh3am50Oi7vG7Q
