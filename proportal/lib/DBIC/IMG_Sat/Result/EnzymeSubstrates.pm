use utf8;
package DBIC::IMG_Sat::Result::EnzymeSubstrates;
...
=head1 TABLE: C<ENZYME_SUBSTRATES>

=cut

__PACKAGE__->table("ENZYME_SUBSTRATES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lTHPG/RW1DZNeEVYOZoh7w
