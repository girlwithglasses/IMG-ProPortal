use utf8;
package DBIC::IMG_Sat::Result::BiocycEnzrxnProsthGroups;
...
=head1 TABLE: C<BIOCYC_ENZRXN_PROSTH_GROUPS>

=cut

__PACKAGE__->table("BIOCYC_ENZRXN_PROSTH_GROUPS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NZospzYrUJPYU9GgAkcD+A
