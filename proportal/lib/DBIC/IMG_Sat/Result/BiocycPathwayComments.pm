use utf8;
package DBIC::IMG_Sat::Result::BiocycPathwayComments;
...
=head1 TABLE: C<BIOCYC_PATHWAY_COMMENTS>

=cut

__PACKAGE__->table("BIOCYC_PATHWAY_COMMENTS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Kdtd+WrHy3C0vM4yEYE+DA
