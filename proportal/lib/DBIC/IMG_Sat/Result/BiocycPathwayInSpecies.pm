use utf8;
package DBIC::IMG_Sat::Result::BiocycPathwayInSpecies;
...
=head1 TABLE: C<BIOCYC_PATHWAY_IN_SPECIES>

=cut

__PACKAGE__->table("BIOCYC_PATHWAY_IN_SPECIES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nTbsT4HDmpkMXrPpdVDk5Q
