use utf8;
package DBIC::IMG_Sat::Result::KeggModuleKoTerms;
...
=head1 TABLE: C<KEGG_MODULE_KO_TERMS>

=cut

__PACKAGE__->table("KEGG_MODULE_KO_TERMS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DRG8HAAN9gIRK7ytQuNAFQ
