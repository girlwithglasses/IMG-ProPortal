use utf8;
package DBIC::IMG_Sat::Result::BiocycCompTypes;
...
=head1 TABLE: C<BIOCYC_COMP_TYPES>

=cut

__PACKAGE__->table("BIOCYC_COMP_TYPES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:n7h6hSXIXn0FiY71Ecf95w
