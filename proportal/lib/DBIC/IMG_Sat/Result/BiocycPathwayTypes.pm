use utf8;
package DBIC::IMG_Sat::Result::BiocycPathwayTypes;
...
=head1 TABLE: C<BIOCYC_PATHWAY_TYPES>

=cut

__PACKAGE__->table("BIOCYC_PATHWAY_TYPES");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:npF17yttAhDaKMznbZZmAQ
