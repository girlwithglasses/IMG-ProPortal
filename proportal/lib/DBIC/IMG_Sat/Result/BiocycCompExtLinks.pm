use utf8;
package DBIC::IMG_Sat::Result::BiocycCompExtLinks;
...
=head1 TABLE: C<BIOCYC_COMP_EXT_LINKS>

=cut

__PACKAGE__->table("BIOCYC_COMP_EXT_LINKS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lCfhKZ8Fo5GEEamCEoVtpg
