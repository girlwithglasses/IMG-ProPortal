use utf8;
package DBIC::IMG_Sat::Result::BiocycProteinExtLinks;
...
=head1 TABLE: C<BIOCYC_PROTEIN_EXT_LINKS>

=cut

__PACKAGE__->table("BIOCYC_PROTEIN_EXT_LINKS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C7Eqxr8RTj2rGHuB8Q5RNA
