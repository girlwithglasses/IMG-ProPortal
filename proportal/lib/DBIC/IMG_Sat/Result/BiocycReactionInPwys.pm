use utf8;
package DBIC::IMG_Sat::Result::BiocycReactionInPwys;
...
=head1 TABLE: C<BIOCYC_REACTION_IN_PWYS>

=cut

__PACKAGE__->table("BIOCYC_REACTION_IN_PWYS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OS6cbGPI7mBAZxxg5sxX7w
