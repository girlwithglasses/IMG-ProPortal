use utf8;
package DBIC::IMG_Sat::Result::BiocycEnzrxnSynonyms;
...
=head1 TABLE: C<BIOCYC_ENZRXN_SYNONYMS>

=cut

__PACKAGE__->table("BIOCYC_ENZRXN_SYNONYMS");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hyWNFcqt5uO+xL8aRyzDKQ
