use utf8;
package DbSchema::IMG_Core::Result::GoldAnalysisProject;
...
Related object: L<DbSchema::IMG_Core::Result::GoldApGenbank>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rvkJmF7G1eWMTymIhrt69Q
