use utf8;
package DbSchema::IMG_Core::Result::XProjectInfoNp;
...
DbSchema::IMG_Core::Result::XProjectInfoNp
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oDWt0KTNlmVGPpt1Vo7sKA
