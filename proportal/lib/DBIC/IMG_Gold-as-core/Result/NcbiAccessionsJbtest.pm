use utf8;
package DbSchema::IMG_Core::Result::NcbiAccessionsJbtest;
...
DbSchema::IMG_Core::Result::NcbiAccessionsJbtest
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:W23C5SjyK6Fvx2jcOtGGgw
