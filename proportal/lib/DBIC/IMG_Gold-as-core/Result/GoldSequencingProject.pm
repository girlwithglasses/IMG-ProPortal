use utf8;
package DbSchema::IMG_Core::Result::GoldSequencingProject;
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpCellArrangement>

=cut

__PACKAGE__->has_many(
  "gold_sp_cell_arrangements",
  "DbSchema::IMG_Core::Result::GoldSpCellArrangement",
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpCollaborator>

=cut

__PACKAGE__->has_many(
  "gold_sp_collaborators",
  "DbSchema::IMG_Core::Result::GoldSpCollaborator",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpDisease>

=cut

__PACKAGE__->has_many(
  "gold_sp_diseases",
  "DbSchema::IMG_Core::Result::GoldSpDisease",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpEnergySource>
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpGenomePublication>
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpHabitat>

=cut

__PACKAGE__->has_many(
  "gold_sp_habitats",
  "DbSchema::IMG_Core::Result::GoldSpHabitat",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpMetabolism>

=cut

__PACKAGE__->has_many(
  "gold_sp_metabolisms",
  "DbSchema::IMG_Core::Result::GoldSpMetabolism",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpPhenotype>

=cut

__PACKAGE__->has_many(
  "gold_sp_phenotypes",
  "DbSchema::IMG_Core::Result::GoldSpPhenotype",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpRelevance>

=cut

__PACKAGE__->has_many(
  "gold_sp_relevances",
  "DbSchema::IMG_Core::Result::GoldSpRelevance",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpSeqCenter>
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpSeqMethod>
...
Related object: L<DbSchema::IMG_Core::Result::GoldSpStudyGoldId>

=cut

__PACKAGE__->has_many(
  "gold_sp_study_gold_ids",
  "DbSchema::IMG_Core::Result::GoldSpStudyGoldId",
  { "foreign.gold_id" => "self.gold_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xMkoI6iHmrE220vLssophA
