use utf8;
package DbSchema::IMG_Core::Result::MetagenomicClassNode;
...
DbSchema::IMG_Core::Result::MetagenomicClassNode
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nK5ZF7P0PJAEOVUBIVH9Rg
