use utf8;
package DbSchema::IMG_Core::Result::Submission;
...
Related object: L<DbSchema::IMG_Core::Result::SubmissionDataFile>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:J3dYUtF0DsmtRWgQi6Wq7Q
