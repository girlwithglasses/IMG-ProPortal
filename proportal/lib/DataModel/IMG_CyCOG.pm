...
# DBIx::DataModel->Schema('DataModel::IMG_CyCOG')->Association(
#   [qw/CycogRelease                    version                  1    cycog_version      /],
#   [qw/GeneCycog                       cycogs                   *    cycog_version      /]);

DataModel::IMG_CyCOG->Type( Date =>
	fromDB => sub {
...
#                                           =========     ==================
DataModel::IMG_CyCOG::CycogRelease->metadm->define_column_type( Date    => qw/ date_created /);

package DataModel::IMG_CyCOG::Cycog;
