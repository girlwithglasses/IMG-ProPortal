...
IMG::IO::FileSystem - Miscellaneous file system-related utility routines

=head2 SYNOPSIS

	use strict;
	use warnings;
	use IMG::IO::FileSystem;
...
my $read_h = {
	hash => sub { return IMG::IO::File::file_to_hash( @_ ); },
	aoa  => sub { return IMG::IO::File::file_to_aoa( @_ ); },
