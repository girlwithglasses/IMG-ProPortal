...
subtest 'timed test' => sub {
	...
	my $app = TestApp->new( config => {}, http_params => {} );
	...
	is( 'passed', $app->time_me( 2, $fn, 1 ), 'Checking a timed function' );

	local $@;
	is( undef, $app->time_me( 1, $fn, 2 ), 'Checking another timed function' );
