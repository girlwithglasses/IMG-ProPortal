...
subtest 'file touching' => sub {
	...
	throws_ok { IMG::Util::File::file_touch() } qr[No file specified];
	throws_ok { IMG::Util::File::file_touch('A made up file') } qr[ does not exist];
	my ($fh, $fn) = tempfile();
	my $t = time;
