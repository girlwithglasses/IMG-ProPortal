...
# --es 09/17/2004
#
# $Id: ScaffoldGraph.pm 36954 2017-04-17 19:34:04Z klchu $
############################################################################
...
sub printScaffoldGraph {
    ...
    if ( $scaffold_oid eq "" ) {
        WebUtil::webDie("printScaffoldGraph: scaffold_oid not defined\n");
    }
    ...
    my $hint_part = "<img style='left: 0px;' src='$crispr_png' "
    ...
    if ( $color eq "gc" ) {
        ...
        print "<p>\n";
        print "Color code of function category for top COG hit is shown below.<br/>\n";
